  ...
  return (
    <React.Fragment>
      ...
      <div className="grid gap-4 gap-y-10 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        <Card current = {length} showVal = {1} text={codes.default} title={"Default"}>
          <MultipleObserver>
            <CircularProgressBar />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.stroke_color} title={"Stroke color"}>
          <MultipleObserver>
            <CircularProgressBar color={"#57C5B6"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.track_color} title={"Track color"}>
          <MultipleObserver>
            <CircularProgressBar trackColor={"#00ff0088"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.radius} title={"Radius value"}>
          <MultipleObserver>
            <CircularProgressBar radius={"7rem"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.solid} title={"Style : Solid"}>
          <MultipleObserver>
            <CircularProgressBar styles={"solid"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.separators} title={"Style : Separators"}>
          <MultipleObserver>
            <CircularProgressBar styles={"separators"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.pie_chart} title={"Style : Pie-Chart"}>
          <MultipleObserver>
            <CircularProgressBar styles={"pie-chart"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.size} title={"Stroke size"}>
          <MultipleObserver>
            <CircularProgressBar size={"0.5rem"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.percentage} title={"Percentage"}>
          <MultipleObserver>
            <CircularProgressBar percentage={90} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.duration} title={"Duration"}>
          <MultipleObserver>
            <CircularProgressBar duration={1000} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {1} text={codes.start_position} title={"Start position"}>
          <MultipleObserver>
        ...
        <Card current = {length} showVal = {2} text={codes.inner_shadow} title={"Custom inner shadow"}>
          <MultipleObserver>
            <CircularProgressBar
              shadow={true}
              innerShadowStyle={{
        ...
        <Card current = {length} showVal = {2} text={codes.outer_shadow} title={"Custom outer shadow"}>
          <MultipleObserver>
            <CircularProgressBar
              shadow={true}
              outerShadowStyle={{
        ...
        <Card current = {length} showVal = {2} text={codes.show_percentage} title={"Percentage"}>
          <MultipleObserver>
            <CircularProgressBar showPercentage={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {2} text={codes.percentage_style} title={"Custom percentage style"}>
          <MultipleObserver>
            <CircularProgressBar
              percentageStyle={{
                fontSize: "1.8rem",
        ...
        <Card current = {length} showVal = {2} text={codes.text_style} title={"Custom text style"}>
          <MultipleObserver>
            <CircularProgressBar
              text={"React"}
              textStyle={{
        ...
        <Card current = {length} showVal = {2} text={codes.childrens} title={"Childrens"}>
          <MultipleObserver>
            <CircularProgressBar showPercentage={false}>
              <img
        ...
        <Card current = {length} showVal = {2} text={codes.linecap} title={"Linecap"}>
          <MultipleObserver>
            <CircularProgressBar roundLineCap={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {2} text={codes.animation} title={"Animation"}>
          <MultipleObserver>
            <CircularProgressBar animation={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {2} text={codes.p_animation} title={"Percentage animation"}>
          <MultipleObserver>
            <CircularProgressBar percentageAnimation={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {2} text={codes.reverse} title={"Reverse"}>
          <MultipleObserver>
            <CircularProgressBar reverse={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {2} text={codes.r_duration} title={"Reverse duration"}>
          <MultipleObserver>
            <CircularProgressBar reverseDuration={1000} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.loop_w_r} title={"Loop with reverse"}>
          <MultipleObserver>
            <CircularProgressBar loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.loop_wo_r} title={"Loop without reverse"}>
          <MultipleObserver>
            <CircularProgressBar loopCount={5} reverse={false} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.start_delay} title={"Start delay"}>
          <MultipleObserver>
            <CircularProgressBar startDelay={1000} loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.reverse_delay} title={"Reverse delay"}>
          <MultipleObserver>
            <CircularProgressBar reverseDelay={1000} loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.anticlockwise} title={"Forward direction"}>
          <MultipleObserver>
            <CircularProgressBar antiClockWise={true} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.background} title={"Background color"}>
          <MultipleObserver>
            <CircularProgressBar backgroundColor={"#BBD6B8"} />
          </MultipleObserver>
        </Card>

        <Card current = {length} showVal = {3} text={codes.padding} title={"Padding"}>
          <MultipleObserver>
            <CircularProgressBar
              padding={"1rem"}
              backgroundColor={"#BBD6B8"}
        ...
        <Card current = {length} showVal = {3} text={codes.separators_style} title={"Customize separators"}>
          <MultipleObserver>
            <CircularProgressBar
              styles={"separators"}
              separator={[5, 8, "white"]}
        ...
        <Card current = {length} showVal = {3} text={codes.pie_chart_style} title={"Customize pie-chart"}>
          <MultipleObserver>
            <CircularProgressBar
              styles={"pie-chart"}
              chartValue={{
      ...
      <div className="grid gap-4 gap-y-10 md:grid-cols-2 xl:grid-cols-3">
        <Card current = {length} showVal = {4} text={codes.sample_1} title={"Sample - 1"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
        ...
        <Card current = {length} showVal = {4} text={codes.sample_2} title={"Sample - 2"}>
          <CircularProgressBar
            shadow={true}
            color={["#7149c6", "#fc2947"]}
            loopCount={Infinity}
        ...
        <Card current = {length} showVal = {4} text={codes.sample_3} title={"Sample - 3"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            showPercentage={false}
            size={"0.7rem"}
        ...
        <Card current = {length} showVal = {4} text={codes.sample_4} title={"Sample - 4"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
        ...
        <Card current = {length} showVal = {4} text={codes.sample_5} title={"Sample - 5"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
      ...
      {/* add button */}
      <button
        className={(length === 4) ? "hidden" : "flex" +
