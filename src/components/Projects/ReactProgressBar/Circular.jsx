  ...
  return (
    <React.Fragment>
      ...
      <div className="grid gap-4 gap-y-10 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        ...
        <Card text={codes.radius} title={"Radius value"}>
          <MultipleObserver>
            <CircularProgressBar radius={"7rem"} />
          </MultipleObserver>
        </Card>

        <Card text={codes.solid} title={"Style : Solid"}>
          <MultipleObserver>
            <CircularProgressBar styles={"solid"} />
          </MultipleObserver>
        </Card>

        <Card text={codes.separators} title={"Style : Separators"}>
          <MultipleObserver>
            <CircularProgressBar styles={"separators"} />
          </MultipleObserver>
        </Card>

        <Card text={codes.pie_chart} title={"Style : Pie-Chart"}>
          <MultipleObserver>
            <CircularProgressBar styles={"pie-chart"} />
          </MultipleObserver>
        </Card>

        <Card text={codes.size} title={"Stroke size"}>
          <MultipleObserver>
        ...
        <Card text={codes.start_position} title={"Start position"}>
          <MultipleObserver>
            <CircularProgressBar startPosition={90} />
          </MultipleObserver>
        </Card>

        <Card text={codes.shadow} title={"Shadow"}>
          <MultipleObserver>
            <CircularProgressBar shadow={true} />
          </MultipleObserver>
        </Card>

        <Card text={codes.inner_shadow} title={"Custom inner shadow"}>
          <MultipleObserver>
            <CircularProgressBar
              shadow={true}
              innerShadowStyle={{
        ...
        <Card text={codes.outer_shadow} title={"Custom outer shadow"}>
          <MultipleObserver>
            <CircularProgressBar
              shadow={true}
              outerShadowStyle={{
        ...
        <Card text={codes.percentage_style} title={"Custom percentage style"}>
          <MultipleObserver>
            <CircularProgressBar
              percentageStyle={{
                fontSize: "1.8rem",
        ...
        <Card text={codes.childrens} title={"Childrens"}>
          <MultipleObserver>
            <CircularProgressBar showPercentage={false}>
              <img
        ...
        <Card text={codes.reverse} title={"Reverse"}>
          <MultipleObserver>
            <CircularProgressBar reverse={false} />
          </MultipleObserver>
        </Card>

        <Card text={codes.r_duration} title={"Reverse duration"}>
          <MultipleObserver>
            <CircularProgressBar reverseDuration={1000} />
          </MultipleObserver>
        </Card>

        <Card text={codes.loop_w_r} title={"Loop with reverse"}>
          <MultipleObserver>
            <CircularProgressBar loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card text={codes.loop_wo_r} title={"Loop without reverse"}>
          <MultipleObserver>
            <CircularProgressBar loopCount={5} reverse={false} />
          </MultipleObserver>
        </Card>

        <Card text={codes.start_delay} title={"Start delay"}>
          <MultipleObserver>
            <CircularProgressBar startDelay={1000} loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card text={codes.reverse_delay} title={"Reverse delay"}>
          <MultipleObserver>
            <CircularProgressBar reverseDelay={1000} loopCount={5} />
          </MultipleObserver>
        </Card>

        <Card text={codes.anticlockwise} title={"Forward direction"}>
          <MultipleObserver>
            <CircularProgressBar antiClockWise={true} />
          </MultipleObserver>
        </Card>

        <Card text={codes.background} title={"Background color"}>
          <MultipleObserver>
            <CircularProgressBar backgroundColor={"#BBD6B8"} />
          </MultipleObserver>
        </Card>

        <Card text={codes.padding} title={"Padding"}>
          <MultipleObserver>
            <CircularProgressBar
              padding={"1rem"}
              backgroundColor={"#BBD6B8"}
        ...
        <Card text={codes.separators_style} title={"Customize separators"}>
          <MultipleObserver>
            <CircularProgressBar
              styles={"separators"}
              separator={[5, 8, "white"]}
        ...
        <Card text={codes.pie_chart_style} title={"Customize pie-chart"}>
          <MultipleObserver>
            <CircularProgressBar
              styles={"pie-chart"}
              chartValue={{
      ...
      <div className="grid gap-4 gap-y-10 md:grid-cols-2 xl:grid-cols-3">
        <Card text={codes.sample_1} title={"Sample - 1"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
        ...
        <Card text={codes.sample_2} title={"Sample - 2"}>
          <CircularProgressBar
            shadow={true}
            color={["#7149c6", "#fc2947"]}
            loopCount={Infinity}
        ...
        <Card text={codes.sample_3} title={"Sample - 3"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            showPercentage={false}
            size={"0.7rem"}
        ...
        <Card text={codes.sample_4} title={"Sample - 4"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
        ...
        <Card text={codes.sample_5} title={"Sample - 5"}>
          <CircularProgressBar
            color={["#fc2947", "#7149c6"]}
            trackColor={"#D8D8D866"}
            shadow={true}
