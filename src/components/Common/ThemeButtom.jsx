...
const ThemeButton = () => {
  ...
  return (
    <React.Fragment>
      <div
        className="fixed bottom-16 left-0 flex h-10 w-11 cursor-pointer items-center rounded-r-full bg-slate-800
            ps-1 drop-shadow-md duration-300 ease-in dark:bg-slate-100"
        id="theme-btn"
      ...
      <div
        className="fixed bottom-5 left-0 flex h-32 w-11 -translate-x-11 flex-col justify-between rounded-r-xl bg-slate-800 py-1
            pe-2 ps-1 drop-shadow-md duration-300 ease-in dark:bg-slate-100"
